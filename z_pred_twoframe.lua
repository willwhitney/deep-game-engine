...
cmd:option('--coder',             '',                             'the containing folder of the network to use as en/de-coder')
...
cmd:option('--dim_prediction',    1024,           'dimension of the prediction layer')

cmd:option('--input_replication', 20,             'number of times to replicate controller input in input to predictor')
...
while true do
    ...
    lowerbound_test = test_z_prediction_twoframe(false)
    if true then
